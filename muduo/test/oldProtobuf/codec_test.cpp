...
{
	int32_t checkSum = sockets::hostToNetwork32(static_cast<int32_t>(::adler32(1, reinterpret_cast<const Bytef*>(data.c_str()),
...
void onMessage(const muduo::net::TcpConnectionPtr& conn, const MessagePtr& message, muduo::Timestamp receiveTime)
{
	g_count++;
}
...
// -lz adler32
// g++ codec_test.cpp codec.cpp query.pb.cc --std=c++11 -lmuduo_base -lmuduo_net -lpthread -lprotobuf -lz
// export CPLUS_INCLUDE_PATH=/root/build/release-install/include:$CPLUS_INCLUDE_PATH
// export LIBRARY_PATH=/root/build/release-install/lib:$LIBRARY_PATH
// export LD_LIBRARY_PATH=/root/build/release-install/lib:$LD_LIBRARY_PATH
